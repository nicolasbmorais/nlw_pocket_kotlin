...
val mockMarkets = listOf(
    Market(
        ...
        coupons = 5,
        rules = listOf(
            Rule(id = "r1", description = "supermarket", marketId = "1"),
            Rule(id = "r2", description = "supermarket", marketId = "1")
        ),
        latitude = -23.563210,
        longitude = -46.654321,
        ...
        coupons = 2,
        rules = listOf(
            Rule(id = "r3", description = "restaurant", marketId = "2"),
            Rule(id = "r4", description = "restaurant", marketId = "2")
        ),
        latitude = -23.550520,
        longitude = -46.633308,
        ...
        coupons = 3,
        rules = listOf(
            Rule(id = "r5", description = "pharmacy", marketId = "3")
        ),
        latitude = -23.557890,
        longitude = -46.662120,
        ...
        coupons = 1,
        rules = listOf(
            Rule(id = "r6", description = "bakery", marketId = "4")
        ),
        latitude = -23.561234,
        longitude = -46.645678,
        ...
        coupons = 4,
        rules = listOf(
            Rule(id = "r7", description = "petshop", marketId = "5"),
            Rule(id = "r8", description = "petshop", marketId = "5")
        ),
        latitude = -23.564001,
        longitude = -46.651234,
